...
app.post('/bills', (req, res) => {
  ...
  const query = 'INSERT INTO bills (serverName, dateTime, tableNumber, products, totalAmount) VALUES (?, ?, ?, ?, ?)';
  connection.query(query, [serverName, dateTime, tableNumber, products, totalAmount], (error, results) => {
    if (error) {
